...
int main(int argc ,char *argv[])
{
	...
	if (argc < 8){
			fprintf(stderr ,"Use ./a.out fname observer_height degreeStart degreeEnd degreeStep coordinate_file_name thread_num\n\n");
			exit(1);
	}
	//////////////////////////////////////////////////////////
	...
	{	
		...
		{			
			...
			//rotation
			for (idegree = degreemin_per_rank; idegree < degreemax_per_rank; idegree=idegree+degreestep)
			{
