...
int main(int argc ,char *argv[])
{
	...
	if (argc < 8 ){
		fprintf(stderr ,"Use ./a.out fname observer_height degreeStart degreeEnd degreeStep coordinate_file_name number_of_threads\n\n");
		exit(1);
	}
	...
	for (i = 0; i < number_of_coordinates; i++)
	{
		...
		int transformax = degreemax/degreestep;
		int transformin = degree/degreestep;
		int p;
